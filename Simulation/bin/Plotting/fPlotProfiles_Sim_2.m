function fPlotProfiles_Sim_2(simPa, Results)
...
if simPa.Conv == 1 % Convolve profile with Gaussian PSF
    ...
    % Calculate maximum of each profile
    for n = 1 : nProfiles
        maximum_D(n) = max(Profile_Dynein{n,1});
        maximum_MT(n) = max(Profile_MT{n,1});
    end
